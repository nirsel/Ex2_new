...
int main(int argc, char** argv){
  ...
  16:	34a080e7          	jalr	842(ra) # 35c <cpu_process_count>
  1a:	85aa                	mv	a1,a0
  1c:	00000517          	auipc	a0,0x0
  20:	7c450513          	addi	a0,a0,1988 # 7e0 <malloc+0xe6>
  24:	00000097          	auipc	ra,0x0
  28:	618080e7          	jalr	1560(ra) # 63c <printf>
...
000000000000035c <cpu_process_count>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ac:	44850513          	addi	a0,a0,1096 # 7f0 <digits>
 3b0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 478:	37cb8b93          	addi	s7,s7,892 # 7f0 <digits>
 ...
 5b8:	23490913          	addi	s2,s2,564 # 7e8 <malloc+0xee>
        while(*s != 0){
...
free(void *ap)
{
 ...
 680:	18c7b783          	ld	a5,396(a5) # 808 <freep>
 ...
 6ae:	00e6ea63          	bltu	a3,a4,6c2 <free+0x50>
{
 ...
 6f0:	10f73e23          	sd	a5,284(a4) # 808 <freep>
}
 6f4:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 722:	0ea53503          	ld	a0,234(a0) # 808 <freep>
 ...
 74a:	0c290913          	addi	s2,s2,194 # 808 <freep>
  if(p == (char*)-1)
 74e:	5afd                	li	s5,-1
 750:	a88d                	j	7c2 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 752:	00000797          	auipc	a5,0x0
 756:	0be78793          	addi	a5,a5,190 # 810 <base>
 75a:	00000717          	auipc	a4,0x0
 75e:	0af73723          	sd	a5,174(a4) # 808 <freep>
 762:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 784:	08a73423          	sd	a0,136(a4) # 808 <freep>
      return (void*)(p + 1);
