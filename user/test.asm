...
int main(int argc, char** argv){
   ...
   e:	36c080e7          	jalr	876(ra) # 376 <sleep>
    printf("cpu 1 is %d\n", cpu_process_count(0));
  12:	4501                	li	a0,0
  14:	00000097          	auipc	ra,0x0
  18:	382080e7          	jalr	898(ra) # 396 <cpu_process_count>
  1c:	85aa                	mv	a1,a0
  1e:	00000517          	auipc	a0,0x0
  22:	7fa50513          	addi	a0,a0,2042 # 818 <malloc+0xe4>
  26:	00000097          	auipc	ra,0x0
  2a:	650080e7          	jalr	1616(ra) # 676 <printf>
    printf("cpu 2 is %d\n", cpu_process_count(1));
  2e:	4505                	li	a0,1
  30:	00000097          	auipc	ra,0x0
  34:	366080e7          	jalr	870(ra) # 396 <cpu_process_count>
  38:	85aa                	mv	a1,a0
  3a:	00000517          	auipc	a0,0x0
  3e:	7ee50513          	addi	a0,a0,2030 # 828 <malloc+0xf4>
  42:	00000097          	auipc	ra,0x0
  46:	634080e7          	jalr	1588(ra) # 676 <printf>
    printf("cpu 3 is %d\n", cpu_process_count(2));
  4a:	4509                	li	a0,2
  4c:	00000097          	auipc	ra,0x0
  50:	34a080e7          	jalr	842(ra) # 396 <cpu_process_count>
  54:	85aa                	mv	a1,a0
  56:	00000517          	auipc	a0,0x0
  5a:	7e250513          	addi	a0,a0,2018 # 838 <malloc+0x104>
  5e:	00000097          	auipc	ra,0x0
  62:	618080e7          	jalr	1560(ra) # 676 <printf>
    exit(0);
  66:	4501                	li	a0,0
...
0000000000000396 <cpu_process_count>:
