...
int main(int argc, char** argv){
   ...
   c:	292080e7          	jalr	658(ra) # 29a <fork>
  10:	85aa                	mv	a1,a0
        printf("pid is %d\n", pid);
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 38a:	45250513          	addi	a0,a0,1106 # 7d8 <digits>
 38e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 456:	386b8b93          	addi	s7,s7,902 # 7d8 <digits>
 ...
 596:	23e90913          	addi	s2,s2,574 # 7d0 <malloc+0xf8>
        while(*s != 0){
...
free(void *ap)
{
 ...
 65e:	1967b783          	ld	a5,406(a5) # 7f0 <freep>
 ...
 68c:	00e6ea63          	bltu	a3,a4,6a0 <free+0x50>
{
 ...
 6ce:	12f73323          	sd	a5,294(a4) # 7f0 <freep>
}
 6d2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 700:	0f453503          	ld	a0,244(a0) # 7f0 <freep>
 ...
 728:	0cc90913          	addi	s2,s2,204 # 7f0 <freep>
  if(p == (char*)-1)
 72c:	5afd                	li	s5,-1
 72e:	a88d                	j	7a0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 730:	00000797          	auipc	a5,0x0
 734:	0c878793          	addi	a5,a5,200 # 7f8 <base>
 738:	00000717          	auipc	a4,0x0
 73c:	0af73c23          	sd	a5,184(a4) # 7f0 <freep>
 740:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 762:	08a73923          	sd	a0,146(a4) # 7f0 <freep>
      return (void*)(p + 1);
